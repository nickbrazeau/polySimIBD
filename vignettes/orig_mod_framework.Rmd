...
Here, we will use the function `plot_coalescence_trees` to make a plot of the marginal tree for each loci, per the user specifications. Note, users have previously limited the TMRCA with the $t_{lim}$ option, specifying the definition of IBD as recent coalescence.   
```{r, fig.align = 'center', fig.width = 6, fig.height = 4, fig.retina = 5}
plot_coalescence_trees(ARG = ARG, loci = 1)
```
