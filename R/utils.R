...
#'
#' @name argraph
#' @description A list of \class{bvtree} for each discrete-loci, which constitutes the ARG 
NULL
...
#' @description  The \class {bv_tree} class is a lightweight representation of a marginal tree
NULL
