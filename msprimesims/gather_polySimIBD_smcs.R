...
simfiles <- list.files(path = "~/Documents/MountPoints/mountedScratchLL/Projects/polySimIBD/_rslurm_sim_Forward_sWF_runs/",
                       ".RDS", full.names = T)
simfiles <- simfiles[!grepl("f.RDS|params.RDS", simfiles)]
params <- readRDS("~/Documents/MountPoints/mountedScratchLL/Projects/polySimIBD/_rslurm_sim_Forward_sWF_runs//params.RDS")
